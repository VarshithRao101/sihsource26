...
| **Delft3D model** | `modules/03_delft3d/engine.py` — detection only, both kernels | Absence is **measured**, not asserted; gate-enforced | 🔴 **kernel not built** |
...
| (i) Delft3D and the engine comparison | 🔴 **kernel not built** |
